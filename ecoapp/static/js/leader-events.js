(() => {
  const startInput = document.getElementById('create_start_time');
  const endInput = document.getElementById('create_end_time');
  const durationInput = document.getElementById('create_duration');
  const warningText = document.getElementById('create_time_warning');
  const createEventForm = startInput ? startInput.form : null;
